...
#TODO: distinguish terminal goals (stage 1) (what success looks like overall) from intermediate milestones that indicate progress
# source: https://www.mindstudio.ai/blog/what-is-loop-engineering-autonomous-ai-agent-workflows

# these stages are a sequence of prompts to help guide a human through the initialization of a from-scratch software project.
STAGES = {
    1: {
